  ...
  const [templates, setTemplates] = useState<Template[]>([
    {
      ...
      type: "Справка",
      content:
        "Справка выдана {{lastName}} {{firstName}} {{middleName}} в том, что он(а) работает в должности {{position}} с {{hireDate}}.",
    ...
    },
    {
      ...
      type: "Характеристика",
      content:
        "Характеристика на {{lastName}} {{firstName}} {{middleName}}, табельный номер {{employeeNumber}}, работающего в должности {{position}}.",
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Характеристика">
                        Характеристика
                      </SelectItem>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-2">
                    Доступные переменные: {"{lastName}"}, {"{firstName}"},{" "}
